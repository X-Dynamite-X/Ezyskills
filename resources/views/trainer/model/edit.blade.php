            ...
            <form id="editUserForm" class="p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="status" id="status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white">
                ...
                <!-- Error Message -->
                <div id="errorMessage" class="mt-4 text-sm text-red-600 dark:text-red-500 hidden"></div>
